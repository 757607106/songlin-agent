...
from src.storage.postgres.models_text2sql import Base as Text2SqlBase
...
class PostgresManager(metaclass=SingletonMeta):
    ...
    async def create_tables(self):
        ...
        async with self.async_engine.begin() as conn:
            ...
            await conn.run_sync(Text2SqlBase.metadata.create_all)
        logger.info("PostgreSQL tables created/checked (knowledge + business + text2sql)")
