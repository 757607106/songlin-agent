...
from src.knowledge.indexing import SUPPORTED_FILE_EXTENSIONS, process_file_to_markdown
from src.utils import logger

ATTACHMENT_ALLOWED_EXTENSIONS: tuple[str, ...] = SUPPORTED_FILE_EXTENSIONS
