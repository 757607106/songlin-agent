"""Runtime context service — validation and runtime context builder.

Provides:
- Team configuration validation (DAG checks, naming, overlap detection)
- Runtime context generation for multi-worker runtime execution
"""
...
class RuntimeContextService:
    ...
    2. Generate runtime contexts for agent platform execution
    """
    ...
    def build_runtime_context(
        ...
        *,
        ...
        runtime_audit = {
            ...
            "builder_version": "agent-platform-runtime-context-v1",
